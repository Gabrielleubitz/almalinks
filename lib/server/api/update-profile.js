...
const ALLOWED_TOP_LEVEL = new Set([
  ...
  'title', 'position', 'organization', 'company', 'phone',
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (merged.organization !== undefined) merged.company = merged.organization;
    ...
    const profileForHubSpot = {
      ...
      _lookupEmail: (current.email || '').toString().trim().toLowerCase() || null,
    };
