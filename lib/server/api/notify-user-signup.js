 ...
 * - MAILCHIMP_API_KEY or MANDRILL_API_KEY: Required - Mailchimp/Mandrill API key for sending emails
...
— Alma Links Team`;
    ...
    // Get Mailchimp/Mandrill API key
    const apiKey = process.env.MAILCHIMP_API_KEY || process.env.MANDRILL_API_KEY;
    if (!apiKey) {
      const errorMsg = 'MAILCHIMP_API_KEY / MANDRILL_API_KEY not configured';
