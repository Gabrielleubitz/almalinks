 ...
 * Send signup confirmation / "We received your signup" email via Mandrill (Mailchimp Transactional) only.
 ...
 *
 * Env: MAILCHIMP_API_KEY (Mandrill), TRANSACTIONAL_FROM_EMAIL (required, @almalinks.org),
...
<p><a href="${escapeHtml(loginLink)}">Log in or check status</a> · <a href="${escapeHtml(eventsLink)}">Events</a></p>
