...
const REMINDER_TEMPLATES = {
  speaker: {
    email: {
      subject: "🎤 Speaker Reminder: AlmaLinks Event Tomorrow",
      content: `
        Hi {name},
        
        This is your speaker brief for tomorrow's AlmaLinks event:
    ...
    sms: "🎤 Speaker reminder: AlmaLinks event {time} at {location}. Arrive 30min early for tech check. Use VIP entrance. See you there!"
  },
  
  attendee: {
    email: {
      subject: "🍷 AlmaLinks Event Tomorrow - You're All Set!",
      content: `
        Hi {name},
        
        Get ready for an incredible AlmaLinks event tomorrow!
    ...
    sms: "🍷 AlmaLinks event tomorrow {time} at {location}. Show your ticket for quick entry. Can't wait to see you!"
  },
  
  vip: {
    email: {
      subject: "🌟 VIP Access: AlmaLinks Event Tomorrow",
      content: `
        Hi {name},
        
        Your VIP experience at AlmaLinks starts tomorrow:
    ...
    sms: "🌟 VIP reminder: AlmaLinks event tomorrow. Early access {vip_time} via VIP entrance (left side). Premium experience awaits!"
  }
};
...
const POST_EVENT_TEMPLATES = {
  thankYou: {
    subject: "🍷 Thank You for Joining AlmaLinks!",
    content: `
      Hi {name},
      ...
      Looking forward to seeing you at the next AlmaLinks event.
  ...
  survey: {
    subject: "📋 Quick Survey: How was AlmaLinks?",
    content: `
      Hi {name},
      ...
      **📊 Quick 2-minute survey:** {survey_link}
      ...
      Thanks for being part of AlmaLinks!
  ...
  nps: {
    subject: "⭐ Would you recommend AlmaLinks?",
    content: `
      Hi {name},
      
      Thanks again for joining us at "{event_name}"!
      
      **Quick question:** On a scale of 0-10, how likely are you to recommend AlmaLinks to a friend or colleague?
          ...
          if (template) {
            ...
            try {
              await resend.emails.send({
                from: 'AlmaLinks <events@wineandgrind.com>',
