 ...
 * Returns all documents from Firestore hubspotDeals (for admin UI list).
...
export default async function handler(req, res) {
  ...
  try {
    const snap = await db.collection('hubspotDeals').get();
    ...
    console.error('[list-hubspot-deals] Error:', err);
