 ...
 * Non-negotiable: ANY delete MUST satisfy importedFrom === "hubspot" and (for users) hubspotId present.
 *
...
export default async function handler(req, res) {
  ...
  try {
    // --- Users: QUERY only importedFrom === 'hubspot', then filter caller + admins + require hubspotId ---
