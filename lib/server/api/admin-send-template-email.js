 ...
 * Body: { "to": "email@domain.com", "template": "welcome" | "test" | "welcome-approved" | "event-announcement" | "registration-confirmation" | "event-reminder" | "password-reset" | "user-credentials" }
 * Uses Mailjet or Mandrill (same as other transactional emails).
 */
import '../firebase-init.js';
import { auth } from '../firebase-init.js';
import { getAppBaseUrl, getLoginLink, getEventsLink } from '../email-config.js';
