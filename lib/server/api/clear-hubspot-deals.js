 ...
 *
 * Deletes ONLY HubSpot-imported deals: query where importedFrom === 'hubspot'.
 * Never wipes the whole collection. Auth: admin Bearer or x-sync-secret.
 */
...
export default async function handler(req, res) {
  ...
  try {
    ...
    logHubspotDeleteAudit('clear-hubspot-deals', authResult.uid, { deals: deleted });
