...
/**
 * Build the full AlmaLinks email document (Inter, 700px, MSO-friendly).
 * Structure: Alma logo → main content (innerHtml) → Thanks + logo → Footer (AlmaLinks.org, unsubscribe, Igani).
 *
...
export function wrapInAlmaTheme(innerHtml, options = {}) {
  ...
  // Gmail and many clients block SVG; use PNG. Set EMAIL_LOGO_URL / EMAIL_IGANI_LOGO_URL to full PNG URLs, or add logo.png + igani-logo-placeholder.png to public/
										...
										<tbody>
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top;">
														...
														<tr>
															<td class="pad" style="padding: 44px 24px 24px;">
																<div style="color:#4a4f5f;direction:ltr;font-family:'Inter','Helvetica',sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:1.6;text-align:center;">
																	<p style="margin: 0 0 8px 0;">You received this email because you have an account or subscribed to updates from AlmaLinks.</p>
																	...
																	<p style="margin: 16px 0 0 0;">${footerUnsubscribeBlock}© ${new Date().getFullYear()} AlmaLinks. All rights reserved.</p>
																</div>
															</td>
														</tr>
													</table>
													<table class="image_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;padding-bottom: 32px; text-align: center;">
																<table align="center" cellpadding="0" cellspacing="0" border="0" role="presentation" style="margin: 0 auto;">
																	<tr>
																		<td style="font-size: 11px; color: #6B7280; font-family: 'Inter','Helvetica',sans-serif; vertical-align: middle; padding-right: 6px;">Powered by</td>
																		<td style="vertical-align: middle;">
																			<a href="https://www.igani.co" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
																				<img src="${attr(iganiLogoUrl)}" alt="igani" width="80" height="32" style="display: block; border: 0; max-width: 80px; height: auto;" />
																			</a>
																		</td>
																	</tr>
																</table>
																<p style="margin: 8px 0 0 0; font-size: 12px;"><a href="https://www.igani.co" target="_blank" rel="noopener noreferrer" style="color: #1e40ff; text-decoration: none;">igani.co</a></p>
															</td>
														</tr>
													</table>
												</td>
