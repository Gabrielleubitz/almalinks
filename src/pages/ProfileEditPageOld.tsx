      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
        ...
        <div className="pt-20 pb-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Link
              to="/dashboard"
              className="inline-flex items-center space-x-2 text-brand-light hover:text-blue-700"
            >
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="inline-flex items-center space-x-2 px-6 py-2 bg-brand-dark text-white rounded-xl hover:bg-brand-mid disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
              >
                {saving ? (
          ...
          <div className="mb-8">
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-medium text-brand-light">{completionPercentage}%</span>
              </div>
