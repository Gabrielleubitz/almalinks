          ...
          <div className="space-y-8">
            ...
            <div className="p-6 border border-gray-200 rounded-xl">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {googleLinked 
                          ? `Linked to ${user?.googleEmail || 'your Google account'}` 
                          : 'Not linked'}
                      </p>
                    </div>
                  </div>
                  {googleLinked ? (
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-white border-2 border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
                    >
                      {linkingGoogle ? (
                        <>
                ...
                {googleLinked && (
                  <p className="text-sm text-gray-500">
                    You can now sign in using your Google account. When you sign in with Google, you'll be taken to this account.
                  </p>
                )}
              </div>
            </div>
