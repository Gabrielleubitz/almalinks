...
const TermsAgreementModal: React.FC<TermsAgreementModalProps> = ({ onAgree }) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby={step === 1 ? 'terms-modal-title' : 'beta-modal-title'}
    >
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        {step === 2 && (
          <>
            <div className="p-6 sm:p-8 flex-shrink-0 overflow-y-auto">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center">
                  <Info className="h-5 w-5 text-[var(--brand-light)]" />
                </div>
                <h2 id="beta-modal-title" className="text-xl font-bold text-gray-900">
                  AlmaLinks is in beta
                </h2>
              </div>
              <p className="text-gray-600 text-sm sm:text-base mb-4">
                AlmaLinks is currently in beta and is offered in partnership with Igani. We are actively improving the platform and appreciate your patience.
              </p>
              <p className="text-gray-600 text-sm mb-4">
                If you encounter any bugs or errors, please go to the{' '}
                <Link to="/help" className="text-[var(--brand-light)] font-medium hover:underline" target="_blank" rel="noopener noreferrer">
                  Help section
                </Link>{' '}
                to report them. Your feedback helps us build a better experience for everyone.
              </p>
              <p className="text-gray-800 text-base font-medium mt-6 pt-4 border-t border-gray-100">
                Thank you for being part of the AlmaLinks community.
              </p>
            </div>
