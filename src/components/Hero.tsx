    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-white pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 fade-in">
          ...
          <div className="flex justify-center slide-up px-4">
            {user ? (
              isPending ? (
                <Link
                  to="/pending"
                  className="bg-yellow-600 text-white px-6 sm:px-8 md:px-10 py-3 sm:py-4 rounded-full hover:bg-yellow-700 transition-colors duration-200 font-semibold text-sm sm:text-base md:text-lg flex items-center space-x-2 hover-lift w-full sm:w-auto max-w-xs sm:max-w-none justify-center"
                >
                ...
                <Link
                  to="/events"
                  className="bg-red-700 text-white px-6 sm:px-8 md:px-10 py-3 sm:py-4 rounded-full hover:bg-red-800 transition-colors duration-200 font-semibold text-sm sm:text-base md:text-lg flex items-center space-x-2 hover-lift w-full sm:w-auto max-w-xs sm:max-w-none justify-center"
                >
